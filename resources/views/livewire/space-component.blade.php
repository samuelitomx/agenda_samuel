<div class="py-6" x-data="{
    ...
    edit(spaceData) {
        ...
        this.setSpace = {
            ...
            days_for_settlement: spaceData.days_for_settlement,
            price_for_hour: spaceData.price_for_hour,
            minimum_amount: spaceData.minimum_amount,
    ...
    update() {
        ...
        $wire.update(this.setSpace).then(() => {
    ...
    destroy() {
        ...
        $wire.destroy(this.setSpace).then(() => {
    ...
    <div style="background-color: #fff" class="overflow-hidden shadow-xl sm:rounded-lg px-4 py-4 ml-4 mr-4">
        ...
        <div style="display: none" class="fixed z-10 inset-0 overflow-y-auto ease-out duration-500" x-show="createModal"
            ...
            <div class="flex justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                ...
                <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-2x2 sm:w-full md:w-3/5 lg:w-3/5 xl:w-3/5" {{-- 3/5 --}}
                    ...
                    <div {{-- class="bg-gradient-to-br from-gray-800 to-blue-900 px-4 pt-5 pb-4 sm:p-6 sm:pb-4 rounded-lg text-white" --}} style="background-color: #003554;"
                        ...
                        <h3 class="text-2xl font-semibold text-white mb-4">Nuevo Sala</h3>
                        ...
                        <div class="mb-4 px-10">
                            ...
                            <main class="mb-4 px-10">
                                ...
                                <div class="mb-4">
                                    <label for="text" class="block text-white text-sm font-bold mb-2">Nombre:</label>
                                    <input type="text" x-data="{ focused: false }"
                                        ...
                                        id="name" x-model="space.name">
                                </div>

                                <div class="mb-4">
                                    <label for="text" class="block text-white text-sm font-bold mb-2">Description:</label>
                                    <input type="text" x-data="{ focused: false }"
                                        x-bind:class="{ 'bg-white': focused, 'bg-gray-300': !focused }"
                                        x-on:focus="focused = true" x-on:blur="focused = false"
                                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                        id="name" x-model="space.description">
                                </div>

                                <div class="mb-4">
                                    <label for="text" class="block text-white text-sm font-bold mb-2">Dimensiones:</label>
                                    <input type="text" x-data="{ focused: false }"
                                        x-bind:class="{ 'bg-white': focused, 'bg-gray-300': !focused }"
                                        x-on:focus="focused = true" x-on:blur="focused = false"
                                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                        id="name" x-model="space.dimensions">
                                </div>

                                <div class="mb-4">
                                    <label for="text" class="block text-white text-sm font-bold mb-2">Capacidad:</label>
                                    <input type="text" x-data="{ focused: false }"
                                        x-bind:class="{ 'bg-white': focused, 'bg-gray-300': !focused }"
                                        x-on:focus="focused = true" x-on:blur="focused = false"
                                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                        id="name" x-model="space.capacity">
                                </div>

                                <div class="mb-4">
                                    <label for="start" class="block text-white text-sm font-bold mb-2">Tema:</label>
                                    <input type="text" x-data="{ focused: false }"
                                        x-bind:class="{ 'bg-white': focused, 'bg-gray-300': !focused }"
                                        x-on:focus="focused = true" x-on:blur="focused = false"
                                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                        id="name" x-model="space.theme">
                                </div>

                                <div class="mb-4">
                                    <label for="start" class="block text-white text-sm font-bold mb-2">Dias para liquidar:</label>
                                    <input type="text" x-data="{ focused: false }"
                                        x-bind:class="{ 'bg-white': focused, 'bg-gray-300': !focused }"
                                        x-on:focus="focused = true" x-on:blur="focused = false"
                                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                        id="name" x-model="space.days_for_settlement">
                                </div>

                                <div class="mb-4">
                                    <label for="start" class="block text-white text-sm font-bold mb-2">Precio por hora:</label>
                                    <input type="text" x-data="{ focused: false }"
                                        x-bind:class="{ 'bg-white': focused, 'bg-gray-300': !focused }"
                                        x-on:focus="focused = true" x-on:blur="focused = false"
                                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                        id="name" x-model="space.price_for_hour">
                                </div>

                                <div class="mb-4">
                                    <label for="start" class="block text-white text-sm font-bold mb-2">Monto minimo:</label>
                                    <input type="text" x-data="{ focused: false }"
                                        x-bind:class="{ 'bg-white': focused, 'bg-gray-300': !focused }"
                                        x-on:focus="focused = true" x-on:blur="focused = false"
                                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                        id="name" x-model="space.minimum_amount">
                                </div>
        ...
        <div style="display: none" class="fixed z-10 inset-0 overflow-y-auto ease-out duration-500" x-show="updateModal"
            ...
            <div class="flex justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                ...
                <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-2x2 sm:w-full md:w-3/5 lg:w-3/5 xl:w-3/5"
                    role="dialog" aria-modal="true" aria-labelledby="modal-headline">

                    <div style="background-color: #003554;"
                        class=" px-4 pt-5 pb-4 sm:p-6 sm:pb-4 rounded-lg text-white">

                        <h3 class="text-2xl font-semibold text-white mb-4">Actualizar Sala</h3>
                            ...
                            <main class="mb-4 px-10">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" x-data="{ focused: false }"
                                        ...
                                        x-on:focus="focused = true" x-on:blur="focused = false"
                                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                        id="name" x-model="setSpace.description">
                                </div>

                                <div class="mb-4">
                                    <label for="text"
                                        class="block text-white text-sm font-bold mb-2">Dimensiones:</label>
                                    <input type="text" x-data="{ focused: false }"
                                        x-bind:class="{ 'bg-white': focused, 'bg-gray-300': !focused }"
                                        x-on:focus="focused = true" x-on:blur="focused = false"
                                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                        id="name" x-model="setSpace.dimensions">
                                </div>


                                <div class="mb-4">
                                    <label for="start" class="block text-white text-sm font-bold mb-2">Capacidad de personas:</label>
                                    <input type="text" x-data="{ focused: false }"
                                        x-bind:class="{ 'bg-white': focused, 'bg-gray-300': !focused }"
                                        x-on:focus="focused = true" x-on:blur="focused = false"
                                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                        id="name" x-model="setSpace.capacity">
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" x-data="{ focused: false }"
                                        ...
                                        x-on:focus="focused = true" x-on:blur="focused = false"
                                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                        id="name" x-model="setSpace.theme">
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" x-data="{ focused: false }"
                                        ...
                                        x-on:focus="focused = true" x-on:blur="focused = false"
                                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                        id="name" x-model="setSpace.days_for_settlement">
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" x-data="{ focused: false }"
                                        ...
                                        x-on:focus="focused = true" x-on:blur="focused = false"
                                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                        id="name" x-model="setSpace.price_for_hour">
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" x-data="{ focused: false }"
                                        ...
                                        x-on:focus="focused = true" x-on:blur="focused = false"
                                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                        id="name" x-model="setSpace.minimum_amount">
                                </div>
            ...
            <div class="flex justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                ...
                <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-2xl sm:w-full md:w-3/5 lg:w-3/5 xl:w-3/5"
                    ...
                    <div style="background-color: #003554;"
                        ...
                        <h3 class="text-2xl font-semibold text-white mb-4">Eliminar Sala</h3>
                ...
                <div class="flex flex-col flex-1 h-full overflow-hidden">
                    ...
                    <main class="flex-1 max-h-full p-5 overflow-hidden overflow-y-scroll">
                        ...
                        <div
                            ...
                            <h3 class="text-2xl font-semibold whitespace-nowrap text-black">Espacios</h3>
                            <div class="space-y-6 md:space-x-2 md:space-y-0">
                                ...
                                <button x-on:click="showCreateModal()"
                                    ...
                                    style="background-color: #004d74; hover:">Agregar Sala</button>
                            ...
                            <div style="background-color: #D5DEEF;"
                                ...
                                <div class="flex items-start justify-between">
                                    <div class="flex flex-col space-y-2">
                                        <span class="text-black">Salaes totales</span>
                                        <span class="text-lg font-semibold text-black">{{ $quantity }}</span>
                                    </div>


                                    <img class="max-w-[150px] h-auto object-cover"
                                        src="https://cdn-icons-png.flaticon.com/256/4799/4799496.png">
                                            ...
                                            <tbody class="bg-white divide-y divide-gray-200">
                                                ...
                                                @foreach ($spaces as $space)
                                                    <tr class="transition-all hover:bg-gray-100 hover:shadow-lg">
                                                        ...
                                                        <td class="px-6 py-4 whitespace-nowrap">
                                                            <div class="text-sm text-gray-900">
                                                                {{ $space->days_for_settlement }}<label> dias para liquidar</label>
                                                            </div>
                                                            <div class="text-sm text-gray-500">
                                                                {{ $space->price_for_hour }}
                                                            </div>
                                                        </td>

                                                        <td class="px-6 py-4 whitespace-nowrap">
                                                            <div class="text-sm text-gray-900">
                                                                {{ $space->minimum_amount }}
                                                            </div>
                                                        ...
                                                        <td
                                                            ...
                                                            <button
                                                                ...
                                                                x-on:click="edit( {{ json_encode($space) }})"></button>
                                                            <button
                                                                class="bi bi-trash3-fill  text-blue-900 hover:text-blue-600 font-bold py-2 px-2"
                                                                x-on:click="findToDestroy( {{ json_encode($space) }})"></button>
